...
- **Inventory counting** — Count stock across all categories with real-time OK / Low / Out status
- **Order dashboard** — Auto-generates order lists for items below par, grouped by vendor
...
Single-file HTML app — all HTML, CSS, and JavaScript are self-contained in one file. No dependencies, no backend, no build tools.
